...
async function scrapePrice(url) {
  const browser = await puppeteer.launch({
    executablePath: '/home/runner/.cache/puppeteer/chrome/linux-121.0.6167.85/chrome-linux64/chrome',
    headless: 'new',
  });
...
async function run() {
  ...
  console.log('🧪 Puppeteer launch config:', {
    executablePath: puppeteer.executablePath ? puppeteer.executablePath() : 'default',
    browserRevision: puppeteer?.browserRevision,
  });
